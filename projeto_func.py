...
def editar_tarefa():
    ...
    for tarefa in banco_de_dados:
            if tarefa['nome'] == nome:
                ...
                campo = input('Digite o nome do campo a ser editado: ')
                if campo in tarefa:
                    novo_valor = input('Digite o novo nome para o campo selecionado: ').lower()
                    if campo == 'Nome':
                        tarefa[campo] = novo_valor
                    elif campo == 'Descrição':
                        tarefa[campo] = novo_valor
                    elif campo == 'Prioridade':
                        tarefa[campo] = int(novo_valor)
                    elif campo == 'Categoria':
                        tarefa[campo] = novo_valor
                    elif tarefa[campo] == 'Data':
                        tarefa[campo] = novo_valor
                    elif tarefa[campo] == 'Concluido':
                        tarefa[campo] = novo_valor.lower() == 'sim'
                    else:
                        tarefa[campo] == novo_valor
